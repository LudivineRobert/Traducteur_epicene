...
#determinant part
defini= re.sub(r"\b(le|la)\b","l·e·a",text)
print(defini)
...
indefnegatifpl2= re.sub(r"\bnul(s|es)\b","nul·le·s",text)
print(indefnegatifpl2)

dindeftotalite= re.sub(r"\b(tout|toutes)\b","tout·e·s",text)
print(dindeftotalite)

indefpluralite1= re.sub(r"\bcertain(s|es)\b","certain·e·s",text)
print(indefpluralite1)

indefpluralite2= re.sub(r"\bdiver(s|ses)\b","divers·es",text)
print(indefpluralite2)

indefpluralite3= re.sub(r"\bdifférent(s|es)\b","différent·e·s",text)
...
ppossessif1= re.sub(r"\b(le\smien|la\smienne)\b","l·e·a mien·ne",text)
print(ppossessif1)

ppossessif2= re.sub(r"\b(le\stien|la\stienne)\b","l·e·a tien·ne",text)
print(ppossessif2)

ppossessif3= re.sub(r"\b(le\ssien|la\ssienne)\b","l·e·a sien·ne",text)
print(ppossessif3)

ppossessif4= re.sub(r"\b(le\snôtre|la\snôtre)\b","l·e·a nôtre",text)
print(ppossessif4)

ppossessif5= re.sub(r"\b(le\svôtre|la\svôtre)\b","l·e·a vôtre",text)
print(ppossessif5)

ppossessif6= re.sub(r"\b(le\sleur|la\sleur)b","l·e·a leur",text)
print(ppossessif6)
